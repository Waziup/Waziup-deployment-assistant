...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private void showMissingPermissionDialog() {
        ...
        dialogBuilder.setMessage("Allow Permission");
        dialogBuilder.setNegativeButton("quite", (dialog, which) -> {
            setResult(PERMISSIONS_DENIED);
            finish();
        });
        dialogBuilder.setPositiveButton("settings", (dialog, which) -> startAppSettings());
        dialogBuilder.show();
    }
